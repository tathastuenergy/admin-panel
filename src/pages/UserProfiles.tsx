...
//         >
//           {loading ? "Please wait" : "Save Company"}
//          </button>
//       </div>
//     </ComponentCard>
//     </>
...
export default function UserProfiles() {
  ...
  const isProfileEnabled = isFormEnabled("profile"); // Check if estimate form is enabled
  ...
  // Clear errors when profile is disabled
  useEffect(() => {
    if (!isProfileEnabled) {
      setErrors({});
    }
                ...
                <div className="mt-2">
                  <div className="relative">
                    ...
                    <button
                      ...
                      onClick={handleRemoveLogo}
                      className={`absolute -top-2 -right-2 bg-gray-600 text-white rounded-full w-7 h-7 flex items-center justify-center hover:bg-gray-700 shadow-md ${
                        !isProfileEnabled ? "opacity-50 cursor-not-allowed" : ""
                      }`}
                      title="Remove logo"
                      disabled={!isProfileEnabled}
                    >
                  ...
                  <div className="mt-3">
                    <label
                      className={`cursor-pointer inline-block w-full px-4 py-2 text-sm text-center bg-white border border-gray-300 rounded hover:bg-gray-50 transition ${
                        !isProfileEnabled ? "opacity-50 cursor-not-allowed" : ""
                      }`}
                    >
                      Change Logo
